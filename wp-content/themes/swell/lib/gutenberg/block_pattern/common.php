...
'<!-- /wp:paragraph -->' . $n .
$n .
'<!-- wp:loos/button {"hrefUrl":"###","iconName":"icon-cart","className":"is-style-btn_normal blue_"} -->' . $n .
'<div class="swell-block-button is-style-btn_normal blue_"><a href="###" class="swell-block-button__link" data-has-icon="1"><i class="icon-cart __icon"></i><span>' . __( 'ボタン', 'swell' ) . '</span></a></div>' . $n .
'<!-- /wp:loos/button -->';
